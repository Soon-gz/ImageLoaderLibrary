...
import com.example.lemonimagelibrary.policy.ReversePolicy;
...
//        File file = new File(Environment.getExternalStorageDirectory(),"1406383299_1976.jpg");

//        LemonImageLoader.with(this)
//                .load(R.mipmap.ic_launcher)
//                .into(imageView);
//                .onFinishListener(new BitmapConfig.BitmapListener() {
//                    @Override
...
//                });
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final ImageView imageView = (ImageView) item.findViewById(R.id.iv);
            //请求图片
            LemonImageLoader.with(MainActivity.this)
                    .load(imageThumbUrls[position])
                    .cachePolicy(CacheMode.MEMORY_LRU_CACHE)
                    .placeHolder(R.mipmap.ic_launcher)
                    .loaderPolicy(new ReversePolicy())
                    .onFinishListener(new BitmapConfig.BitmapListener() {
                        @Override
                        public void onSuccess(Bitmap bitmap) {
